              ...
              <div>
                ...
                >
                  <div className="d-flex gap-4 ">
                    ...
                    <div>
                    <button type="button" className="btn btn-outline-light mh-25px">En çok Satanlar</button>
                    </div>
                    <div>
                      
                      <button type="button" className="btn btn-outline-light">Fırsat Ürünleri</button>
                    </div>
                    <div>
                    <button type="button" className="btn btn-outline-light">Kampanyalar</button>
                    </div>
